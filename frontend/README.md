...
- [src/useOverlay.ts](src/useOverlay.ts) — shared body-scroll-lock + Esc-to-close primitive used by both the methodology drawer and the mobile rail drawer
...
Three test files cover the load-bearing UI logic:
